...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Msmes>
 */
class MsmesFactory extends Factory
{
    /**
    ...
    protected $model = Msmes::class;

    public function definition(): array
    {
        return [
            'name' => ucwords(fake()->words(3, true)),
            'category' => strval(fake()->numberBetween(1, 4)),
