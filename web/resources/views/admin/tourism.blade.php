...
@section('content')
    <main class="main">
        ...
        <section>
            <div class="container">
                <div class="card border-0 shadow p-3 mb-2 rounded-4 card-bg table-color">
                    <div class="row my-2">
                        <div class="col-lg-6">
                            <h4 class="text-secondary mx-2">Tabel Konten Pariwisata</h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <span class="badge bg-primary text-white slider-btn" data-id="{{ $item->id }}" style="cursor: pointer;" data-bs-toggle="modal"
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 align-items-center">
                                                    <button class="btn btn-sm text-white rounded-3 color-secondary edit-btn" data-id="{{ $item->id }}" data-bs-toggle="modal"
                                                        data-bs-target="#formModal">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </button>
                                                    <form action="{{ url('/admin/tourism/' . $item->id) }}" method="post">
                                                        @csrf @method('DELETE')
        ...
        <div class="modal modal-xl fade" id="formModal" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content table-color">
                    <form data-default-action="{{ url('/admin/tourism') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control mb-2" id="description" name="description" rows="3" placeholder="Masukkan deskripsi" required></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 mb-2 d-flex justify-content-end">
                                            <span class="badge bg-danger d-flex justify-content-center align-items-center me-1" id="reset-facility-btn" style="cursor: pointer;">
                                                <i class="bi bi-dash-circle"></i>
                                            </span>
                                            <span class="badge bg-success d-flex justify-content-center align-items-center" id="add-facility-btn" style="cursor: pointer;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <label for="link" class="form-label">
                                                Link Gmaps <span class="text-danger">*</span>
                                            </label>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <small class="form-text text-muted">
                                                Jika gratis, isi keduanya dengan 0.
                                            </small>
                                        </div>
        ...
        <!-- Modal Image -->
        <div class="modal fade" id="imgModal" tabindex="-1" aria-labelledby="imgModalLabel" aria-hidden="true" data-url-storage="{{ asset('storage/tourism') }}">
            <div class="modal-dialog">
                <div class="modal-content table-color">
                    <div class="modal-header">
