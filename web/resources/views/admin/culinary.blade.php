...
@section('content')
    <main class="main">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 align-items-center">
                                                    ...
                                                    <form action="{{ url('/admin/culinary/' . $item->id) }}" method="post">
                                                        @csrf @method("DELETE")
        ...
        <div class="modal modal-xl fade" id="formModal" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content table-color">
                    ...
                    <form data-default-action="{{ url('/admin/culinary') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
        ...
        <!-- Modal Image -->
        <div class="modal fade" id="imgModal" tabindex="-1" aria-labelledby="imgModalLabel" aria-hidden="true" data-url-storage="{{ asset('storage/culinary') }}">
            <div class="modal-dialog">
                <div class="modal-content table-color">
                    <div class="modal-header">
