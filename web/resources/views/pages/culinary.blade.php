                ...
                <div class="container card-container">
                    ...
                    <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                        ...
                        <ul class="card-filters isotope-filters">
                            ...
                            <li data-filter=".filter-cafe">Kafe</li>
                            <li data-filter=".filter-restaurant">Rumah Makan</li>
                            <li data-filter=".filter-culinary-center">Sentra Kuliner</li>
                        </ul>
                        ...
                        <div class="row gy-4 isotope-container">
                            ...
                            <div class="col-lg-3 col-md-6 card-item isotope-item filter-food">
                                <a href="culinary-description.html">
                                    <div class="card mb-4 text-white card-hover rounded-4 border-0 shadow">
                                        <img src="assets/img/22 Bakso Terenak Di Malang Yang Harus Kamu Coba.jpg"
                            ...
                            <div class="col-lg-3 col-md-6 card-item isotope-item filter-drink">
                                <a href="culinary-description.html">
                                    <div class="card mb-4 text-white card-hover rounded-4 border-0 shadow">
                                        ...
                                        <img src="assets/img/Regular Cappucino, Regular Hazelnut Latte and doughnuts, Nakoa Coffee, Malang_.jpg"
                                            class="card-img rounded-4" alt="...">
                                        <div class="card-img-overlay rounded-4">
                                            <h5 class="card-title">Cappucino bikin sakit perut</h5>
                                            <p class="card-text">Lihat Selengkapnya <i class="bi bi-arrow-right"></i></p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-lg-3 col-md-6 card-item isotope-item filter-restaurant">
                                <a href="culinary-description.html">
                                    <div class="card mb-4 text-white card-hover rounded-4 border-0 shadow">
                                        <img src="assets/img/Selera Indonesia, Semarang.jpg" class="card-img rounded-4"
                                            alt="...">
                                        <div class="card-img-overlay rounded-4">
                                            <h5 class="card-title">Kayaknya Enak</h5>
                                            <p class="card-text">Lihat Selengkapnya <i class="bi bi-arrow-right"></i></p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-lg-3 col-md-6 card-item isotope-item filter-restaurant">
                                <a href="culinary-description.html">
                                    <div class="card mb-4 text-white card-hover rounded-4 border-0 shadow">
                                        <img src="assets/img/11 Singapore Foods You Have to Try—and Where to Try Them.jpg"
                                            class="card-img rounded-4" alt="...">
                                        <div class="card-img-overlay rounded-4">
                                            <h5 class="card-title">Enaak</h5>
                                            <p class="card-text">Lihat Selengkapnya <i class="bi bi-arrow-right"></i></p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-lg-3 col-md-6 card-item isotope-item filter-food">
                                <a href="culinary-description.html">
                                    <div class="card mb-4 text-white card-hover rounded-4 border-0 shadow">
                                        <img src="assets/img/Penyetan Malang.jpg" class="card-img rounded-4" alt="...">
                                        <div class="card-img-overlay rounded-4">
                                            <h5 class="card-title">Penyetan Malang</h5>
                                            <p class="card-text">Lihat Selengkapnya <i class="bi bi-arrow-right"></i></p>
                                        </div>
                                    </div>
                                </a>
